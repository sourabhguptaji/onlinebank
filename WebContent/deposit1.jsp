...
<div id="header">
	<h1>NEW- BANK<span class="style1"></span></h1>
    <h2>NEW Service</h2>	
...
<tr >
	<td width="300" valign="top" style="border-right:#666666 1px dotted;">
    	<div id="services"><h1>Services</h1><br>
		    <ul>
        	<li><a href="#">www.mobiletech.blogspot.com </a></li>
            <li><a href="#">www.mobiletech.blogspot.com </a></li>
            <li><a href="#">www.mobiletech.blogspot.com </a></li>
            </ul>
    ...
    <td width="1200" valign="top">
		...
		<tr>
			<td><div></div>
				<form name=F1 onSubmit="return dil(this)" action="#" >
...
<div id="footer_top">
  ...
  <div id="footer_copyright" >
		    ...
		    <p>djadwiuhdasjkd hdjskdwhdn djsdasliwdalns</p>
